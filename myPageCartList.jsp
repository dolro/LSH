	...
	<div class="wrapper wrapper2">
		<div class="parent"
			...
			<div class="my_page_left">
				...
				<br>
				<p>
					<a href="myPage.jsp" style="color: black">회원정보 변경/</a><a
						href="myPage1.jsp" style="color: black">탈퇴</a>
				</p>
			</div>
...
.table_boldline2 {
	border-bottom: 2px solid #222222;
				...
				<div class="cart">
					<table class="table table-bordered" id="tbl-product">
						...
						<tr>
							...
							<td>top</td>
							<td>옵션</td>
							<td><input type="number" class="edt-qty" value="1" min="0" style="width: 60%;"></td>
							<td>28,000</td>
							<td>
								<div style="text-align: center; margin: 10px;">
									...
									<br>
									<button type="button" class="btn btn-primary" id="btn-delete" style="width: 7rem; margin: 2px;">관심상품등록</button>
									<br>
					...
					<!--선택상품삭제,선택상품주문,전체상품주문 버튼-->
					<br>
					<div style="text-align: center; margin-bottom: 20px;">
						<button type="button" class="btn btn-primary" id="btn-delete" style="width: 7rem; margin: 2px;">선택상품삭제</button>
						<button type="button" class="btn btn-primary" id="btn-delete" style="width: 7rem; margin: 2px;" onclick="location.href='index_pay2.html' ">선택상품주문</button>
						<button type="button" class="btn btn-primary" id="btn-delete" style="width: 7rem; margin: 2px;" onclick="location.href='index_pay2.html' ">전체상품주문</button>
					</div>
				</div>
			</div>
			<!--TOTAL 박스영역-->
		...
		<!--___________________여기까지________________________________여기까지------------------------>
		<footer>
			<address>
				<p>(주)LogoName</p>
				<p>대표전화 : 1111-2222</p>
