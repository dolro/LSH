...
<body>
    ...
    <div class="parent" style="flex:1;  background: white; display:flex; position:relative;  ">
      ...
      <div class="child" style="width: 70%; text-align: center;   ">
        ...
        <div class="cart" style="text-align:left;">
          ...
          <h2 style="padding-left:2rem;padding-bottom:0.5rem;font-size:1rem;"><strong>주문자 정보</strong></h2>
          ...
          <table class="table_boldline" style="width:100%; ">
            ...
            <tr>
              <td class="talbe_row">주문자</td>
              <td>홍길동</td>
              <td>
                <div style="text-align:center;">
                  <button type="button" class="btn btn-primary" id="btn-delete" style="width:8rem; margin:2px;" onclick="location.href='myPage.jsp'">회원정보확인</button><br>
                </div>
              </td>
          </table>
          ...
          <!--배송지정보-->
          <h2 style="padding-left:2rem;padding-bottom:0.5rem;font-size:1rem;"><strong>배송지 정보</strong></h2>
          <table class="table_boldline" style="width:100%;">
            <colgroup>
              <col style="width: 20%;" />
              <col style="width: 80%" />
            ...
            <tr>
              <td class="talbe_row">수취인</td>
              <td>홍길동</td>
            </tr>
            <tr>
              <td class="talbe_row">연락처</td>
              <td>010-1111-2222</td>
            </tr>
            <tr>
              <td class="talbe_row">배송주소</td>
              <td>영등포구 영등포동</td>
            </tr>
          </table>
          ...
          <!--주문상품-->
          <h2 style="padding-left:2rem;padding-bottom:0.5rem;font-size:1rem;"><strong>주문상품</strong></h2>
          ...
          <table class="table_boldline" style="width:100%;">
            ...
            <tr>
              <td class="talbe_row" rowspan="4">2021-11-10 <br>(123456789) </td>
              <td>
                <div class="img"><img src="./images/pexels-photo-4890733.jpeg" style="width:50%;">
              </td>
        </div>
        <td>pants<br>옵션</td>
        <td>1</td>
  ...
  <!--결제정보-->
  <h2 style="padding-left:2rem;padding-bottom:0.5rem;font-size:1rem;"><strong>결제정보</strong></h2>
  ...
  <table class="table_boldline" style="width:100%;">
    ...
    <tr>
      <td class="talbe_row">결제금액</td>
      <td>128,264</td>
    </tr>
    <tr>
      <td class="talbe_row">결제방법</td>
      <td>카드결제</td>
  </table>
  ...
  <div class="child" style="background: white; width: 5%;">
    <!--오른쪽여백-->
  </div>
  </div>
