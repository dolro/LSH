		...
		<div class="content">
			<form>
				<div class="loginForm">
					...
					<br> <br>
					<div class="ip">
						<input type="radio" name="find" onclick="doDisplay1('0')" checked>
						<label>휴대폰으로 찾기 </label>
					</div>
					<div id="find3" style="display: block; text-align: center;">
						<input type="text" placeholder="아이디" style="margin-bottom: 21px;">
						<input type="text" placeholder="이름" style="margin-bottom: 21px;">
						<div class="certification">
							<input type="text" width="347px" placeholder="- 없이 번호 입력">
							<button>인증번호 전송</button>
							<input type="text" style="margin-bottom: 21px;" placeholder="인증번호">
						</div>
					...
					<div class="ip">
						<input type="radio" name="find" onclick="doDisplay1('1')">
						<label>이메일로 찾기 </label>
					</div>
					<div id="find4" style="display: none; text-align: center;">
						<input type="text" placeholder="아이디" style="margin-bottom: 21px;">
						<input type="text" placeholder="이름" style="margin-bottom: 21px;">
						<input type="text" placeholder="이메일" style="margin-bottom: 21px;">
						<button style="margin-bottom: 42px;">
							<b>확인</b>
						</button>
					</div>
				</div>
