...
<body>
	<div class="wrapper">
		...
		<header>
			<div class="header">
				...
				<div class="search-box">
					<form class="search-form" action="productListTop.do" method="get">
						<select class="category-box" name="searchKeywordType">
							<option ${(param.searchKeywordType =="2")?"selected":"" } value="2">TOP</option>
						</select>
		...
		<div class="content">
			...
			<br>
			<div class="box2">
				<span onclick="location.href='productListTop.do'">전체</span>&nbsp|&nbsp
				<span onclick="location.href='productListTopDESC.do'">높은가격순</span>&nbsp|&nbsp
				<span onclick="location.href='productListTopASC.do'">낮은가격순</span>&nbsp|&nbsp
