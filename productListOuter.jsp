...
<body>
	<div class="wrapper">
		...
		<header>
			<div class="header">
				...
				<div class="search-box">
					<form class="search-form" action="productListOuter.do" method="get">
						<select class="category-box" name="searchKeywordType">
							<option ${(param.searchKeywordType =="4")?"selected":"" } value="4">OUTER</option>
						</select>
		...
		<div class="content">
			...
			<nav id="content_box">
				<div class="box1">
					<h2 align="center">OUTER</h2>
				</div>
			</nav>
			<br>
			<div class="box2">
				<span onclick="location.href='productListOuter.do'">전체</span>&nbsp|&nbsp
				<span onclick="location.href='productListOuterDESC.do'">높은가격순</span>&nbsp|&nbsp
				<span onclick="location.href='productListOuterASC.do'">낮은가격순</span>&nbsp|&nbsp
